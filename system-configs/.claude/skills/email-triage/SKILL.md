...
For EVERY email in the fetch, check if it's recruiter outreach. If yes, hand off to the **recruiter-inbox** skill at `~/.openclaw-clara/workspace/skills/recruiter-inbox/SKILL.md` for scoring and logging.
