...
# 38 skills: git, orchestration, quality, planning, formats, specialized, agent-context,
...
#   renamed from process-bareclaude), ask (D-facing question primitive), and
#   interview (full-understanding protocol)
